...
SECRET_KEY = 'django-insecure-es71q1q_s32!etle5@x$-o^zv)b%^si#a_vrsb@9s&32^j!rnp'
...
cloudinary.config(
    cloud_name = "dduonada5",
    api_key = "716287196965755",
    api_secret = "-tKklXkL5BOnuUPqX3qZgxlXP7E"
)
